/* Fenwick Tree - U64 Small Tier (2-TIER SYSTEM)
 * Auto-generated from template. DO NOT EDIT MANUALLY.
 *
 * Small tier: 0-(16 * 1024) elements, contiguous allocation
 * Upgrades to Full tier when threshold exceeded.
 */

#include "fenwickU64.h"

#define FENWICK_SUFFIX U64
#define FENWICK_VALUE_TYPE uint64_t
