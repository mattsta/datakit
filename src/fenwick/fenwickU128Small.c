/* Fenwick Tree - U128 Small Tier (2-TIER SYSTEM)
 * Auto-generated from template. DO NOT EDIT MANUALLY.
 *
 * Small tier: 0-(8 * 1024) elements, contiguous allocation
...
#define FENWICK_SUFFIX U128
#define FENWICK_VALUE_TYPE __uint128_t
