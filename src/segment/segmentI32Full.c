/* Segment Tree - I32 Full Tier (2-TIER SYSTEM)
 * Auto-generated from template. DO NOT EDIT MANUALLY.
 */

#include "segmentI32.h"

#define SEGMENT_SUFFIX I32
#define SEGMENT_VALUE_TYPE int32_t
#define SEGMENT_INDEX_TYPE_SMALL uint32_t
#define SEGMENT_INDEX_TYPE_FULL uint64_t
#define SEGMENT_TYPE_MIN INT32_MIN
#define SEGMENT_TYPE_MAX INT32_MAX
